import {BoxGeometry, BufferGeometry, Intersection, MeshBasicMaterial, Raycaster, Vector3} from 'three';
...
/**
 * Represents a tile node for a 3D tiles format.
 * 
 * Details about 3D Tiles format at https://www.ogc.org/standard/3dtiles/.
 */
export class Map3DTileNode extends MapNode 
{
	public constructor(parentNode = null, mapView = null, location = QuadTreePosition.root, level = 0, x = 0, y = 0) 
	{
		super(parentNode, mapView, location, level, x, y, new BoxGeometry(), new MeshBasicMaterial());
	...
	public static baseGeometry: BufferGeometry = new MapNodeGeometry(1, 1, 1, 1, false);
