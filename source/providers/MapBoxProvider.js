 ...
 */
function MapBoxProvider(apiToken, id, mode, format, useHDPI)
{
	/**
...
MapBoxProvider.prototype = Object.create(MapProvider.prototype);

MapBoxProvider.prototype.getMetaData = function()
{
	var self = this;
	var address = MapBoxProvider.ADDRESS + this.version + "/" + this.mapId + ".json?access_token=" + this.apiToken;
...
MapBoxProvider.prototype.fetchTile = function(zoom, x, y)
{
