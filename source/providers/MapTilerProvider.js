 ...
 * @param {String} apiKey
 */
function MapTilerProvider(apiKey, type, style, format)
{
...
MapTilerProvider.prototype = Object.create(MapProvider.prototype);

MapTilerProvider.prototype.fetchTile = function(zoom, x, y)
{
