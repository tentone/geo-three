 ...
 */
function HereMapsProvider(appId, appCode, style, scheme, format, size)
{
...
HereMapsProvider.prototype = Object.create(MapProvider.prototype);
 ...
 * @method nextServer
 */
HereMapsProvider.prototype.nextServer = function()
{
	this.server = (this.server % 4 === 0 ? 1 : this.server + 1);
};

HereMapsProvider.prototype.getMetaData = function(){};

HereMapsProvider.prototype.fetchTile = function(zoom, x, y)
{
	this.nextServer();
