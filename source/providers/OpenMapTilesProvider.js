 ...
 */
function OpenMapTilesProvider(address)
{
...
OpenMapTilesProvider.prototype = Object.create(MapProvider.prototype);

OpenMapTilesProvider.prototype.getMetaData = function()
{
	var self = this;
	var address = this.address + "styles/" + this.theme + ".json";
...
OpenMapTilesProvider.prototype.fetchTile = function(zoom, x, y)
{
